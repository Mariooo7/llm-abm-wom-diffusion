...
- `analysis/03_visualizations.py`: 绘制 S 曲线、箱线图，并将论文可直接引用的 PDF 图表输出至 `analysis/figures/`。
...
- `fig1_adoption_s_curves.pdf`: 四组 S 曲线的时间序列均值与置信区间阴影图。
- `fig2_final_metrics_boxplots.pdf`: 最终采纳率与强组 T50 的分组箱线图。
