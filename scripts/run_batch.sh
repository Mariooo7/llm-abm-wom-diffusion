...
LLM_MAX_INFLIGHT="${LLM_MAX_INFLIGHT:-50}"
...
export LLM_DECISION_RETRY_ATTEMPTS
export LLM_DECISION_RETRY_BACKOFF_SECONDS
...
echo "  过程轨迹：$OUTPUT_DIR/adoption_timeline_*.csv"
echo "  原始决策：$RAW_DIR/simulation_*.csv"
echo ""
